...
/**
 * GPT-4o passphrase generator with AI enhancement
 * Uses OpenAI's GPT-4o model via Vercel AI Gateway
 */
export class Gpt4oPassphraseGenerator implements PassphraseGenerator {
  ...
  constructor(private readonly passwordGenerator: PasswordGenerator) {
    ...
    this.model = gateway("openai/gpt-4o");
  }
  ...
  getDescription(): string {
    return "AI-enhanced passphrase generation using OpenAI GPT-4o";
  }
}
